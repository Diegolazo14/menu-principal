  ...
  qt(e) {
    for (const t of e) {
      ...
      if (e2 < 128)
        ...
        this.Bt(960 | e2 >>> 6), this.Bt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t)
        this.Bt(480 | e2 >>> 12), this.Bt(128 | 63 & e2 >>> 6), this.Bt(128 | 63 & e2);
      else {
        const e3 = t.codePointAt(0);
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  async xi() {
    if (this.isPrimary && !this.Oi(this.Ai, 18e5)) {
      ...
      if (this.fi)
        for (const t of e)
          this.fi.removeItem(this.Bi(t.clientId));
    }
  }
  /**
  ...
  Ui(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.Oi(e2.leaseTimestampMs, 5e3) && !this.Li(e2.ownerId) && !this.Fi(e2) && !(this.Pi || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(D.FAILED_PRECONDITION, Ve);
    });
  }
  /**
